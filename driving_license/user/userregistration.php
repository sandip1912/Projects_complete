...
if(isset($_POST['submit'])){
    ...
    //--//--//--//--------------
    if($education == ''){
       $educationError = "Please Choose Atleast One education";
     }
     //--//--//--//--------------
      $photo =  $_FILES['photo'];
    ...
    //--//--//--//--------------
     if(strlen($username)>10) {
         ...
         if (isset($error1) && isset($error2) && !isset($mobileError)&& (!isset($photoExtensionError) || !isset($photoSizeEror)) && !isset($photoExistError) && !isset($errorCPass) &&!isset($errorPass) && !isset($dobError) && !isset($educationError)) {
             $query =" INSERT INTO users(`full_name`, `username`, `email`, `mobile`, `address`, `gender`, `education`, `dob`, `profile_pic`, `city`, `Password`)
             VALUES('$fullName' ,'$username' ,'$Email','$mobile','$address','$gender','$education','$dob','$newPhotoName','$city','$password')";        
...
<body>
    ...
    <form method="POST" enctype="multipart/form-data">
        <table>
            <tr>
                <th colspan="2">NEW REGISTERATION 
            ...
            <tr>
                <td><span>*</span> EDUCATION :</td>
                <td style="text-align: left;"><input type="checkbox" name="education[]" value="8th"  >8th
                    <input  style="margin-left: 45px;" type="checkbox" name="education[]" value="10th"  >10th <br>
                    <input type="checkbox" name="education[]" value="12th"  >12th
                    <input style="margin-left: 35px;" type="checkbox" name="education[]" value="other"  >Other <br>
                    <span>For Other-Education User Computer Test Rules May Change.</span>
                <br> <?php
                    if(isset($educationError)){
                        echo "<span style=color:red;>".$educationError."<?span>";
                    }
                    ?>
                </td>
            </tr> 
            ...
            <tr>  
                <td   style="text-align: center;padding:8px;border-radius:10px" colspan="2"><input type="submit" name="submit" id="" VALUE="REGISTER">
                <br><br>
